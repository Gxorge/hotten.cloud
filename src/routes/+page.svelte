...
<section class="gweb-text-layout">
    <div class="content">
        ...
        <h2>The History</h2>
        <p>
            Hotten Cloud started in January 2022 with a single Raspberry Pi 3. It simply ran Pi-hole and an NGINX web server to host websites. This is still used today, however, now solely running AdGuard. A few months later, in March, I bought a LENOVO ThinkCentre M700 Tiny to act as a primary server for the network. It initially ran docker containers, whilst also storing ripped media and hosting a Jellyfin instance.
            <br><br>
        ...
        <h2>This site is still in progress</h2>
        <p>It is planned to contain a detailed list of services, along side the equipment used.</p>
    </div>
</section>
